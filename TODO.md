...
- [ ] **Add comment to dev compose Docker socket mount** — `docker-compose.dev.yml` line 43 mounts `/var/run/docker.sock` with no explanation. Add a comment noting it grants container-escape capability and is intentional for agent launching.
